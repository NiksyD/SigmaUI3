...
namespace Pepito_Appsdev_Finals.Repository
{
    public class RepositoryStudentGradeFile
    {
        ...
        public RepositoryResult DeleteAllStudentGrades(long studentId)
        {
            var result = new RepositoryResult();
            try
            {
        ...
        public RepositoryResult SaveStudentGrade(long studentId, string subjectCode, string edpCode, double grade, string remarks)
        {
            var result = new RepositoryResult();
            try
            {
                    ...
                    connection))
                {
                    command.Parameters.Add(new SqlParameter("@SGFSTUDID", studentId));
                    command.Parameters.Add(new SqlParameter("@SGFSTUDSUBJCODE", subjectCode));
                    command.Parameters.Add(new SqlParameter("@SGFSTUDSUBJGRADE", grade));
                    command.Parameters.Add(new SqlParameter("@SGFSTUDEDPCODE", edpCode));
                    command.Parameters.Add(new SqlParameter("@SGFSTUDREMARKS", remarks));
